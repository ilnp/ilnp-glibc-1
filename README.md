...
Both are needed. First, get both .deb files linked above. Install them both, e.g. `dpkg -i ilnp*.deb`. Reboot, and then configure using the instructions in [README-ilnp_configure](https://github.com/ilnp/ilnp-public-1/README-ilnp_configure).
