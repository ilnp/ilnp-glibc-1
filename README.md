...
. Extensions to the Linux kernel v4.9 LTS ([here - ilnp-public-1_deb_pkgs.tar.xz](https://github.com/ilnp/ilnp-public-1/blob/master/ilnp-public-1_deb_pkgs.tar.xz)) to implement the ILNP functionality.

Both are needed. First, get both .deb package tair balls linked above. Install all .deb files, e.g. `dpkg -i *.deb`. Reboot, and then configure using the instructions in [README-ilnp_configure](https://github.com/ilnp/ilnp-public-1/blob/master/README-ilnp_configure).
